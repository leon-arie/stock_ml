...
This Application Aims to Predict Future Prices for SPY ETF Index Fund with Machine Learning.''')
...
st.markdown(f'''
### Information About {string_name}''')

string_summary = tickerData.info['longBusinessSummary']
st.info(string_summary)

st.markdown('''
### SPY Price Performance All Time''')
...
closed_stock = tickerDf[tickerDf['Date']>'2016-01-01']
...
st.markdown('''
### Press me to start training the model! 😊''')
...
if st.button('Train the Model'):
    ...
    st.markdown('''
                    This chart shows the past 15 days of closed price data and what the model predicts for the next 5 days.
                    More volatile prices can mean less accurate predictions. The SPY ETF is a good example to use to predict prices because it is less volatile than individual stocks.''')
    ...
    st.markdown('''
                        In conclusion, LSTM is an great model to use when predicting market prices.
                        This is because LSTM takes past closed price predictions as an input for the neural network.
                        But like any machine learning algorithm, some trends will not be captured closely due to the unpredictablity of price movement.
                        ...
                        Since the model only uses the past 15 days worth of data to predict the next close price.
                        
                        The model also has a harder time predicting prices when prices are volatile. 
                        Market prices can be volatile due to many variables like inflation, supply and demand, war, company financial results and unexpected news.
